...
- MIRRORS: A space-separated list of ArchLinux mirror base urls. Each is tried
in order until one provides a bootstrap tarball matching its published sha256
checksum, and all of them are written to the generated pacman mirrorlist.
(Default: "https://geo.mirror.pkgbuild.com
https://mirror.rackspace.com/archlinux https://mirror.leaseweb.net/archlinux")
...
default ("archlinux").  Change the password manually once using the system
within WSL or wherever you intend.
